...
- 🔭 В данный момент работаю над: *АС обработки отзывов*
- Краткое описание проекта:
Система для сбора, фильтрации и анализа отзывов. Разработка нацелена на визуализацию и обработку текстовых данных, чтобы специалисты в разных сферах могли лучше понимать уровень удовлетворённости клиентов, выявлять сильные и слабые стороны сервисов, а также принимать более обоснованные управленческие решения для повышения качества услуг.
